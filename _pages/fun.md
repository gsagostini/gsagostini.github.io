  ...
  <div class="fun-container">
        ...
        <div class="fun-item">
          ...
          <ul>
            <li>
              ...
              focusing on the meaning of participatory urbanism in both art and real life.
            </li>
            <li>
              ...
              Hey, it wouldn't be brutalist enough if I didn't include the whole, uncensored, raw expletive here!
            </li>
          </ul>
        </div>
      </div>
    ...
    <div class="section-header">
      ...
      <div class="fun-list">
        <div class="fun-item">
          <p>
            Mezcal is my adorable yet sometimes grudgy cat. Check out
